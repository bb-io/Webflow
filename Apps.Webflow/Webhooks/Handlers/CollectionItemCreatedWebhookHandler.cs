...
public class CollectionItemCreatedWebhookHandler : WebflowWebhookHandler
{
    ...
    public CollectionItemCreatedWebhookHandler(InvocationContext invocationContext, [WebhookParameter(true)] SiteCmsLocaleRequest siteRequest) : base(invocationContext,
        siteRequest.SiteId)
    {
    }
}